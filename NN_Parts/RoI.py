...
class RoI:
    def __init__(self, backbone_model, IMG_SHAPE, lr=1e-4, n_stage=5):
        ...
        feature_map = tf.keras.Input(shape=feature_map_shape, name='FEATURE_MAP')
        ...
        self.RoI_train_model = tf.keras.Model(inputs=[self.backbone_model.input, proposal_boxes],
